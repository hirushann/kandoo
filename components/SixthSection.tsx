...
export default function SixthSection() {
  return (
    <section className="bg-white">
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center min-h-[900px]">
            <div className="pr-[8%]">
            ...
            <div className="flex lg:max-w-1/2 shrink-0 relative min-w-1/2 pt-8 lg:pt-0">
                ...
                <div className="absolute z-20 right-0 bottom-0">
                    <Image src="/a-girl-speaking.png" alt="Impressive Work" width={410} height={391} className="w-[310px] h-[390px] object-contain lg:w-[410px] lg:h-[390px]" />
                </div>

                <div className="relative p-0 m-0 w-full">
                    <Image src="/chat-ui-temp.webp" alt="Impressive Work" width={393} height={778} className="w-full h-[700px] object-cover lg:w-[393px] lg:h-[778px] relative z-10 m-0 p-0" />
