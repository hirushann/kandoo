        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center min-h-[900px]">
            ...
            <div className="flex max-w-1/2 shrink-0 relative min-w-1/2">
                ...
                <div className="absolute z-20 right-0 bottom-0">
                    <Image src="/a-girl-speaking.png" alt="Impressive Work" width={410} height={391} className="w-[410px] h-[391px]" />
                </div>

                <div className="relative p-0 m-0">
                    <Image src="/chat-ui-temp.webp" alt="Impressive Work" width={393} height={778} className="w-[393px] h-[778px] relative z-10 m-0 p-0" />
